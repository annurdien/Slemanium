...
Also test that nodes that send unsupported service bits to slemaniumd are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if slemaniumd ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
...
class P2PLeakTest(SlemaniumTestFramework):
    def __init__(self):
        super().__init__()
        self.num_nodes = 1
