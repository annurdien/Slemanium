...
class BIP66Test(SlemaniumTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # slemaniumd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and slemaniumd produces more specific reject
            # reasons.
