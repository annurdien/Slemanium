...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SlemaniumTestFramework
    pass

class ExampleTest(SlemaniumTestFramework):
    # Each functional test is a subclass of the SlemaniumTestFramework class.
    ...
    def custom_method(self):
        ...
        SlemaniumTestFramework class so other tests can use it."""
