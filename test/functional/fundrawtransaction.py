...
class RawTransactionsTest(SlemaniumTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid slemanium address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.slemaniumd_processes[1].wait(timeout=SLEMANIUMD_PROC_WAIT_TIMEOUT)
