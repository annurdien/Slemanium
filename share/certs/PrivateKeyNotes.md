...
unlocked to sign the Slemanium-Qt.app bundle.
...
allowing somebody to distribute a Slemanium-Qt.app or slemanium-qt-setup.exe with a valid
...
that the slemanium-qt.exe file inside the installer had not been tampered with.
