...
#if defined(NDEBUG)
# error "Slemanium cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Slemanium Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SLN additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("slemanium-scriptch");
