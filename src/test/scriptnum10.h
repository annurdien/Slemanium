...
#ifndef SLEMANIUM_TEST_SCRIPTNUM10_H
#define SLEMANIUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Slemanium Core 0.10.0, for cross-comparison.
 */
public:
