...
#ifndef SLEMANIUM_WALLET_WALLET_H
#define SLEMANIUM_WALLET_WALLET_H
...
public:
     ...
     * on this slemanium node, and set to 0 for transactions that were created
...
#endif // SLEMANIUM_WALLET_WALLET_H
