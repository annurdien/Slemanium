Slemanium Core version 0.13.2 is now available from:

  <https://slemanium.org/bin/slemanium-core-0.13.2/>
...
- #8908 `4a974b2` Update slemanium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow slemanium-tx to create v2 transactions (slndrak)
