Download URL: https://sourceforge.net/projects/slemanium/files/Slemanium/slemanium-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 SLN fee schedule (users still pay 0.01 SLN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #slemanium00 - #slemanium99
