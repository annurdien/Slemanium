Slemanium Core version 0.9.4 is now available from:

  https://slemanium.org/bin/0.9.4/
...
this update is incompatible with the Slemanium system and could lead to consensus
forks.

Slemanium Core released binaries from https://slemanium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~slemanium/+archive/ubuntu/slemanium
- A third-party or self-compiled Slemanium Core

upgrade to Slemanium Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
