Slemanium-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/slemanium/files/Slemanium/slemanium-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Slemanium
...
New/changed settings (command-line or slemanium.conf file)
--------------------------------------------------------
