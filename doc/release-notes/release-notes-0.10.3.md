Slemanium Core version 0.10.3 is now available from:

  <https://slemanium.org/bin/slemanium-core-0.10.3/>
...
(see https://github.com/slemanium/slemanium/pull/6793, as well as the 0.11.0
