Slemanium Core version 0.9.2.1 is now available from:

  https://slemanium.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 SLN to 0.01 SLN
...
- Fix "Start slemanium on system login"
