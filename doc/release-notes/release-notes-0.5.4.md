Slemanium version 0.5.4 is now available for download at:
http://sourceforge.net/projects/slemanium/files/Slemanium/slemanium-0.5.4/
...
http://gitorious.org/slemanium/slemaniumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Slemanium-Qt notifications under Growl 1.3.
Increase required age of Slemanium-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSlemanium properly when installing Slemanium-Qt over it. (Windows)
