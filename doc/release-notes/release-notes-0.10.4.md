Slemanium Core version 0.10.4 is now available from:

  <https://slemanium.org/bin/slemanium-core-0.10.4/>
...
- #6953 `43c2789` Split slemanium-tx into its own package
- #6953 `dfe0d4d` Include slemanium-tx binary on Debian/Ubuntu
