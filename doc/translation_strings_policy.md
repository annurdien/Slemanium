...
This document provides guidelines for internationalization of the Slemanium Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `slemanium_en.ts` remains unchanged.
